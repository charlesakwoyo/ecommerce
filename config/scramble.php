...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API for the SwiftHub storefront: browse products and categories, manage a cart, place orders and check out via Stripe. Authenticate with `POST /api/v1/login` or `/api/v1/register`, then send the returned token as `Authorization: Bearer <token>`.',
    ],
